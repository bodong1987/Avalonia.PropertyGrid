...
PropertyModels.ComponentModel.CustomPropertyOrderAttribute                          /* You can customize the order in which your object's Category and Property appear in the PropertyGrid based on this property. */  
```
